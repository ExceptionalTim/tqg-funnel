...
export default function Page() {
  ...
  useEffect(() => {
    // Calendar day buttons navigate to time selection
    document.querySelectorAll('button').forEach(function(btn) {
      const t = (btn.textContent || '').trim();
      const n = parseInt(t, 10);
      if (!isNaN(n) && n >= 1 && n <= 31 && t === String(n)) {
  ...
  return (
    <>
      <Head>
        <title>Select a Date — Tour Quality Golf</title>
        <meta charSet="utf-8" />
...
<div class="w-full flex justify-start items-center"><img alt="Tour Quality Golf Logo" class="h-12 w-auto" src="/logo.svg"/></div>
</div>
</header>
...
<!-- Centered Booking Widget - Width constrained and simplified layout -->
<div class="w-full max-w-2xl bg-surface-container-low p-10 rounded-xl border border-outline-variant/10 shadow-2xl">
...
<button class="aspect-square flex items-center justify-center rounded-full text-sm font-semibold hover:bg-primary/10 transition-colors text-on-surface-variant opacity-50">4</button>
<!-- Row 2 -->
<button class="aspect-square flex items-center justify-center rounded-full text-sm font-semibold hover:bg-primary/10 transition-colors text-on-surface-variant opacity-50">5</button>
...
<button class="aspect-square flex items-center justify-center rounded-full text-sm font-semibold hover:bg-primary/10 transition-colors text-on-surface-variant opacity-50">11</button>
<!-- Row 3 -->
<button class="aspect-square flex items-center justify-center rounded-full text-sm font-semibold hover:bg-primary/10 transition-colors text-on-surface-variant opacity-50">12</button>
...
<button class="aspect-square flex items-center justify-center rounded-full text-sm font-semibold hover:bg-primary/10 transition-colors text-on-surface-variant opacity-50">18</button>
<!-- Row 4 -->
<button class="aspect-square flex items-center justify-center rounded-full text-sm font-semibold hover:bg-primary/10 transition-colors text-on-surface-variant opacity-50">19</button>
...
<!-- Highlighted Today (April 21) with teal dot/underline instead of selection -->
<button class="aspect-square flex flex-col items-center justify-center rounded-full text-sm font-semibold hover:bg-primary/10 transition-colors relative">
<span>21</span>
...
<button class="aspect-square flex items-center justify-center rounded-full text-sm font-semibold hover:bg-primary/10 transition-colors text-on-surface-variant opacity-50">25</button>
<!-- Row 5 -->
<button class="aspect-square flex items-center justify-center rounded-full text-sm font-semibold hover:bg-primary/10 transition-colors text-on-surface-variant opacity-50">26</button>
