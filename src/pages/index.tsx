...
<button class="w-full md:w-auto border-2 border-primary-container text-primary-container px-8 py-4 rounded-full font-bold text-lg hover:bg-primary-container hover:text-on-primary-container transition-all uppercase" style="">
...
<h3 class="text-3xl mt-2" style="">FIRST LOOK SESSION: <br/>30 MINUTES ON TRACKMAN</h3>
</div>
<span class="text-5xl text-white font-headline" style="">FREE</span>
</div>
<ul class="space-y-4 mb-10 text-on-surface-variant font-body">
<li class="flex items-center gap-3" style=""><span class="material-symbols-outlined text-secondary" style="">check_circle</span> 30-minute Indoor Bay Access</li>
<li class="flex items-center gap-3" style=""><span class="material-symbols-outlined text-secondary" style="">check_circle</span> Trackman Data Insights</li>
<li class="flex items-center gap-3" style=""><span class="material-symbols-outlined text-secondary" style="">check_circle</span> No strings attached</li>
</ul>
...
<button class="bg-primary-container text-on-primary-container px-10 py-5 rounded-full font-bold text-lg uppercase tracking-tight hover:scale-105 transition-transform" style="">FREE 30 MINUTE Practice</button>
<button class="bg-white text-surface px-10 py-5 rounded-full font-bold text-lg uppercase tracking-tight hover:bg-on-surface-variant transition-colors" style="">BOOK YOUR EVALUATION</button>
</div>
</div>
</section>
...
<div class="flex flex-col sm:flex-row justify-center gap-6">
<button class="bg-surface text-white px-12 py-6 rounded-full font-bold text-xl uppercase tracking-tighter hover:scale-105 transition-transform shadow-xl" style="">CLAIM YOUR FREE BAY</button>
<button class="border-2 border-white text-white px-12 py-6 rounded-full font-bold text-xl uppercase tracking-tighter hover:bg-white hover:text-[#3A3D2E] transition-all" style="">BOOK YOUR EVALUATION</button>
</div>
</section>
